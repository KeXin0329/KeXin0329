...
class VRButton{
	...
	showEnterVR( button ) {
        ...
        function onSessionEnded( ) {
            ...
            button.textContent = 'luna come in';
        ...
        button.onmouseenter = function () {
            ...
            button.textContent = (currentSession===null) ? 'luna come in' : 'EXIT VR';
    ...
    stylizeElement( element, active = true, fontSize = 13, ignorePadding = false ) {
        ...
        element.style.background = (active) ? 'rgba(100,150,80,1)' : 'rgba(100,20,20,1)';
